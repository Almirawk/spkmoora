...
<h1 class="h3 mb-2 text-gray-800">Data Pemeriksaan Event: {{ $event->nama }}</h1>
...
<div class="card shadow mb-4">
    <div class="card-body">
        ...
        <a href="{{ route('events.hasil', ['eventId' => $event->id]) }}" class="btn btn-primary mb-2">
            ...
            <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @php
                        $pemeriksaan = $pendonor->pemeriksaans->firstWhere('kriteria_id', $kriteria->id);
                        ...
                        <td>
                            <div class="d-flex">
                                ...
                                <button type="button" class="btn btn-danger mb-2" data-toggle="modal"
                                    data-target="#deleteModal{{ $pendonor->id }}" data-pendonor-id="{{ $pendonor->id }}">
                                ...
                                <form method="POST" action="{{ route('nilai.update') }}">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            @php
                                            $nilaiRiwayat = $pendonor->pemeriksaans->firstWhere('kriteria_id', $kriteria->id)->nilai ?? '';
                                            @endphp
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{ route('pemeriksaan.destroy', $pendonor->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
